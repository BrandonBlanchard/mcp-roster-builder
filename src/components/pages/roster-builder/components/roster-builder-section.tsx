...
import { Typography, Divider, ListItemButton, ListItemText, ListItem } from '@mui/material';
...
export const RosterBuilderSection: React.FC<RosterBuilderSectionProps> = ({
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', width: '100%', alignSelf: 'stretch' }}>
                <ListItemButton onClick={() => setRosterSectionExpanded(!rosterSectionExpanded)}>
                    <ListItemText primary={<Typography variant='overline' textAlign='left'> {title} {cardIds.length} / {maxCount} </Typography>} />
