...
import {
  Affiliation, CharacterCard, CrisisCard, InfinityGem, McpDataType, TeamTacticsCard,
} from '../../service-models/card-models';
import {
  McpListItemAffiliationContent, McpListItemCharacterContent, McpListItemCrisisContent, McpListItemGemContent, McpListItemTacticContent,
